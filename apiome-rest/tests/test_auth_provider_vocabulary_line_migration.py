"""Guardrails for the LINE vocabulary widen (V202, OLO-9.41, #5054).

DB-free: asserts the migration re-creates both provider CHECK constraints and admits ``line``
while keeping every prior V198 slug.
"""
...
_MIGRATION = "V202__auth_provider_vocabulary_line_5054.sql"
...
def test_admits_line_and_keeps_prior_slugs(migration_text: str) -> None:
    assert "'line'" in migration_text
