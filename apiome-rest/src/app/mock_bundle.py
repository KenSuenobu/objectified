...
#: with the same correlated body the hosted mock does, and ``activeScenario`` (#5531, MSC-2.1) so
#: a bundle defaults to the same scenario the version it was exported from does.
