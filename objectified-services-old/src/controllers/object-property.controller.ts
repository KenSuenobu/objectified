...
import { NamespacesService } from "../../../objectified-services/src/services/namespace.service";
import {
  ApiBody,
  ApiConflictResponse,
  ApiCreatedResponse,
...
export class ObjectPropertiesController {
  ...
  @ApiParam({
    name: "name",
    description:
      "The name of the object property to create - 80 characters in length max.",
  })
  @ApiParam({
    name: "name",
    description:
      "The description to assign to the object property - 4096 characters in length max.",
  })
  @ApiOperation({
    summary: "Creates an Object Property",
    description:
      "Creates a new `ObjectProperty` definition in the `Objectified` system layer.  `ObjectProperty` objects " +
  ...
  @ApiParam({
    name: "id",
    description:
      "The ID of the object property to attach additional `Property` objects against",
  })
  @ApiParam({
    name: "childId",
    description:
      "The ID of the object property to attach to the root `ObjectProperty` object.  This can be any " +
  ...
  @ApiOperation({
    ...
    description:
      "Adds an additional `Property` to an `ObjectProperty` by its ID.",
  })
  @ApiOkResponse({
  ...
  @ApiParam({
    name: "id",
    description:
      "The ID of the object property from which to remove assigned `Property` objects.",
  })
  @ApiParam({
    name: "childId",
    description:
      "The ID of the `Property` to remove from this root object `Property`.",
  })
  @ApiOperation({
    summary: "Removes a Property assigned to an ObjectProperty",
    description:
      "Removes assignment of a `Property` from an `ObjectProperty` object.",
  })
  @ApiOkResponse({
    status: HttpStatus.OK,
    type: ObjectPropertyDto,
  ...
  @ApiForbiddenResponse()
  @ApiUnauthorizedResponse()
  async removePropertyFromObject(
    @Param("id") rootPropertyId: number,
    @Param("childId") childPropertyId: number
  ): Promise<ObjectPropertyDto> {
    return this.service.removePropertyFromObject(
      rootPropertyId,
      childPropertyId
    );
  }
  ...
  @ApiOperation({
    ...
    description:
      "Removes an `ObjectProperty`.  Any `Property` objects assigned to the `ObjectProperty` will also be " +
