...
|---|---|---|---|
| **See every supported format** (generated from the registries) | [supported-formats.md](supported-formats.md) | `/ade/dashboard/catalog` | `GET /v1/import/sources` |
| Import a spec (40+ formats; Projects vs Catalog) | [import-a-spec.md](import-a-spec.md) | `/ade/studio` | `POST /v1/tenants/{tenant}/imports` |
