...
**43<!--format-count:total--> formats, any-to-any**, spanning all 6<!--format-count:paradigms-->
canonical paradigms — REST, RPC, event-driven, graph, data schema and agent:

- Imports 43<!--format-count:importable--> formats.
- Exports 36<!--format-count:exportable--> formats.
- Round-trips 36<!--format-count:round_trip--> of them — import *and* export.
