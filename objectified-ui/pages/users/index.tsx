  ...
  return (
    <>
      <div sx={{ width: '100%' }} style={{ border: '1px solid #ddd', backgroundColor: '#fff' }}>
        ...
        <SectionHeader header={'Users'} onAdd={() => addClassClicked()}>
          <Typography>
            Users are accounts that have access to Objectified.  They are not user accounts that are used by other
            Namespaces in the system - they are internal to the Objectified infrastructure.  You can define user
            classes and structures in different namespaces as you wish - just remember that the users defined here are
            used by Objectified for access to the system.
          </Typography>
        </SectionHeader>
