  ...
  return (
    <>
      <div sx={{ width: '100%' }} style={{ border: '1px solid #ddd', backgroundColor: '#fff' }}>
        ...
        <SectionHeader header={'Groups'} onAdd={() => addClassClicked()}>
          <Typography>
            Groups define objects in common with Users.  Groups are collections of Permissions that can be applied to
            multiple Users.
          </Typography>
        </SectionHeader>
