...
const FORMAT_TO_ADAPTER: Readonly<Record<string, CatalogAdapterSource>> = {
  ...
  wit: { sourceKind: 'wit', label: 'WIT (WebAssembly)' },
  ...
  dtd: { sourceKind: 'dtd', label: 'DTD' },
  doctype: { sourceKind: 'dtd', label: 'DTD' },
  relaxng: { sourceKind: 'relaxng', label: 'RELAX NG' },
  'relaxng-compact': { sourceKind: 'relaxng', label: 'RELAX NG' },
  rng: { sourceKind: 'relaxng', label: 'RELAX NG' },
  rnc: { sourceKind: 'relaxng', label: 'RELAX NG' },
  postman: { sourceKind: 'postman', label: 'Postman' },
  postmancollection: { sourceKind: 'postman', label: 'Postman' },
  'http-file': { sourceKind: 'http-file', label: 'HTTP Request File' },
  http: { sourceKind: 'http-file', label: 'HTTP Request File' },
  rest: { sourceKind: 'http-file', label: 'HTTP Request File' },
  curl: { sourceKind: 'http-file', label: 'HTTP Request File' },
  ...
  cddl: { sourceKind: 'cddl', label: 'CDDL' },
  rfc8610: { sourceKind: 'cddl', label: 'CDDL' },
  'sql-ddl': { sourceKind: 'sql-ddl', label: 'SQL DDL' },
  sql: { sourceKind: 'sql-ddl', label: 'SQL DDL' },
  ddl: { sourceKind: 'sql-ddl', label: 'SQL DDL' },
  postgres: { sourceKind: 'sql-ddl', label: 'SQL DDL' },
  mysql: { sourceKind: 'sql-ddl', label: 'SQL DDL' },
  sqlserver: { sourceKind: 'sql-ddl', label: 'SQL DDL' },
  oracle: { sourceKind: 'sql-ddl', label: 'SQL DDL' },
  dbt: { sourceKind: 'dbt', label: 'dbt Project' },
  'dbt-core': { sourceKind: 'dbt', label: 'dbt Project' },
  'dbt-manifest': { sourceKind: 'dbt', label: 'dbt Project' },
  'schema.yml': { sourceKind: 'dbt', label: 'dbt Project' },
  odcs: { sourceKind: 'odcs', label: 'ODCS Data Contract' },
  datacontract: { sourceKind: 'odcs', label: 'ODCS Data Contract' },
  'data-contract': { sourceKind: 'odcs', label: 'ODCS Data Contract' },
  bitol: { sourceKind: 'odcs', label: 'ODCS Data Contract' },
  'kafka-connect': { sourceKind: 'kafka-connect', label: 'Kafka Connect Schema' },
  kafkaconnect: { sourceKind: 'kafka-connect', label: 'Kafka Connect Schema' },
  'connect-schema': { sourceKind: 'kafka-connect', label: 'Kafka Connect Schema' },
  debezium: { sourceKind: 'kafka-connect', label: 'Kafka Connect Schema' },
  arrow: { sourceKind: 'arrow', label: 'Apache Arrow' },
  'arrow-ipc': { sourceKind: 'arrow', label: 'Apache Arrow' },
  flight: { sourceKind: 'arrow', label: 'Apache Arrow' },
  'arrow-flight': { sourceKind: 'arrow', label: 'Apache Arrow' },
  feather: { sourceKind: 'arrow', label: 'Apache Arrow' },
  ...
  kong: { sourceKind: 'kong', label: 'Kong Declarative Config' },
  'kong-declarative': { sourceKind: 'kong', label: 'Kong Declarative Config' },
  'gateway-api': { sourceKind: 'gateway-api', label: 'Gateway API HTTPRoute' },
  httproute: { sourceKind: 'gateway-api', label: 'Gateway API HTTPRoute' },
  gatewayapi: { sourceKind: 'gateway-api', label: 'Gateway API HTTPRoute' },
  ...
  mcp: { sourceKind: 'mcp', label: 'MCP Server Manifest' },
  'mcp-manifest': { sourceKind: 'mcp', label: 'MCP Server Manifest' },
  modelcontextprotocol: { sourceKind: 'mcp', label: 'MCP Server Manifest' },
  'model-context-protocol': { sourceKind: 'mcp', label: 'MCP Server Manifest' },
...
const FORMAT_TO_PARADIGM: Readonly<Record<string, string>> = {
  ...
  postgres: 'dataschema',
  mysql: 'dataschema',
  sqlserver: 'dataschema',
  oracle: 'dataschema',
  dbt: 'dataschema',
  'dbt-core': 'dataschema',
  'dbt-manifest': 'dataschema',
  'schema.yml': 'dataschema',
  odcs: 'dataschema',
  datacontract: 'dataschema',
  'data-contract': 'dataschema',
  bitol: 'dataschema',
  'kafka-connect': 'dataschema',
  kafkaconnect: 'dataschema',
  'connect-schema': 'dataschema',
  debezium: 'dataschema',
  arrow: 'dataschema',
  'arrow-ipc': 'dataschema',
  flight: 'dataschema',
  'arrow-flight': 'dataschema',
  feather: 'dataschema',
  edix12: 'dataschema',
  x12: 'dataschema',
  edi: 'dataschema',
