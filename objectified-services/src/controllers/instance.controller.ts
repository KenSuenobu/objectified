...
export class InstancesController {
  ...
  @ApiOperation({
    ...
    description:
      'Sets the deleted instance date for a record.  Data that is deleted is simply marked as deleted, but ' +
  ...
  @ApiOperation({
    ...
    description:
      'Removes the deleted date record from the database, but records an additional copy of the last ' +
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves the last data record in an instance by the specified `Instance` ID.',
  })
  @ApiParam({
    name: 'id',
    description: 'The ID of the instance',
  ...
  @ApiForbiddenResponse()
  @ApiUnauthorizedResponse()
  async getLatestInstanceDataForInstance(
    @Param('id') id: number,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves data records in an instance by the specified `Instance` ID.',
  })
  @ApiParam({
    name: 'id',
    description: 'The ID of the instance',
  ...
  @ApiForbiddenResponse()
  @ApiUnauthorizedResponse()
  async getAllInstanceDataForInstance(
    @Param('id') id: number,
  ): Promise<InstanceDataDto[]> {
  ...
  @ApiOperation({
    ...
    description:
      'Searches for a value in a `Property` field of an `InstanceData` record.',
  })
  @ApiBody({
  ...
  @ApiOperation({
    ...
    description:
      'Searches for a value in a `Field` of an `InstanceData` record.',
  })
  @ApiBody({
